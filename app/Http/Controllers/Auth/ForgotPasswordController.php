        ...
        if($user != null){
          ...
          if($mobile_verify->save()){
              ...
              curl_setopt_array($curl, array(
                  CURLOPT_URL => "https://api.mobireach.com.bd/SendTextMessage?Username=lextlink&Password=NextLink@1971&From=Apon%20Health&To=88".$phone."&Message=".urlencode('your varification code: '.$codeverify)."",
