    ...
    public function store(Request $request)
    {
        ...
        if($patient->save()){
            ...
            Mail::send('emails.doctor', compact('mail'), function($message)use($mail,$email_to) {
                $message->from('info@aponhealth.com', 'Apon Health');
                $message->to($email_to)
          ...
          curl_setopt_array($curl, array(
              CURLOPT_URL => "https://api.mobireach.com.bd/SendTextMessage?Username=lextlink&Password=NextLink@1971&From=Apon%20Health&To=88".$phone."&Message=".urlencode($sms)."",
