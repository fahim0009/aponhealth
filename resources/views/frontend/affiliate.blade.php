            ...
            <section class="profile">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 d-flex align-items-center">
                         ...
                         <div class="col-md-7">
                            <input type="text" class="form-control mb-3" placeholder="@if (Auth::user()->ref_id) {{url('users/registration?affiliate_id='.Auth::user()->ref_id)}} @else @endif" name="ref_link" id="ref_link" value="@if (Auth::user()->ref_id) {{url('users/registration?affiliate_id='.Auth::user()->ref_id)}} @else @endif" readonly>
                        </div>
