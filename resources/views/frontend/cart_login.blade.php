                            ...
                            <div class="px-5 py-3 py-lg-5">
                                <div class="row align-items-center">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="input-group input-group--style-1">
                                                            <input type="text" class="form-control form-control-sm {{ $errors->has('email') ? ' is-invalid' : '' }}" max="11" placeholder="{{__('Phone')}}" name="email" id="email" required>
                                    ...
                                    <div class="col-12 col-lg">
                                        <div class="text-center">
                                            <h3 class="heading heading-4 strong-500">
                                                {{__('New to Apon Health? Quickly Register for an account now.')}}
                                            </h3>
                                            ...
                                            <form class="form-default" role="form" action="{{ route('user.register') }}" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="input-group input-group--style-1">
                                                                <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" placeholder="{{ __('Name') }}" name="name" id="name" required>
                                                                <span class="input-group-addon">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="input-group input-group--style-1">
                                                                <input id="phone" type="text" class="form-control @error('error') is-invalid @enderror" placeholder="{{ __('Phone') }}" name="email" required>
                                                                <span class="input-group-addon">
                                                                    <i class="text-md la la-mobile"></i>
                                                                </span>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="input-group input-group--style-1">
                                                                <input type="password" id="password2" class="form-control" placeholder="{{ __('Password') }}" name="password" pattern="{6}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required>
                                                                <span class="input-group-addon">
                                                                    <i class="text-md la la-lock"></i>
                                                                </span>
                                                            </div>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-12 text-right  mt-3">
                                                        <button type="submit" name="register" id="register" class="btn btn-styled btn-base-1 w-100 btn-md">{{ __('Create Account') }}</button>
                                                    </div>
                                                </div>
                                            </form>
                                        {{-- </div> --}}
