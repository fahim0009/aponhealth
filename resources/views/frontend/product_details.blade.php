                ...
                <div class="col-xl-3 d-none d-xl-block">
                    <div class="seller-top-products-box bg-white sidebar-box mb-3">
                        ...
                        <div class="box-content">
                            @foreach (filter_products(\App\Models\Product::where('user_id', $product->user_id)->orderBy('num_of_sale', 'desc'))->limit(4)->get() as $key => $top_product)
                                <div class="mb-3 product-box-3">
                                    <div class="clearfix">
                                        <div class="product-image float-left">
                                            <a href="{{ route('product', $top_product->slug) }}"><img src="{{ asset($top_product->thumbnail_img) }}" height="90" width="90" alt=""></a>
                                        </div>
