                                    ...
                                    <div class="col-12 col-lg">
                                        <form class="form-default" role="form" action="{{ route('user.login.submit') }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    {{-- @if($errors->any('email'))
                                                        <p style="color: rgb(155, 37, 37)">This credentials does not match!!</p>
                                                        @endif --}}
                                                    <div class="form-group">
                                                        ...
                                                        @endif
                                                        @if($errors->has('email'))
                                                        <p style="color: rgb(155, 37, 37)">Phone does not match!!</p>
                                                        @endif --}}
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        @endif
                                                        @if($errors->has('password'))
                                                        <p style="color: rgb(155, 37, 37)">Password is not correct!!</p>
                                                        @endif --}}
                                                    </div>
                                                </div>
                                            </div>
