				...
				<div class="tab-base tab-stacked-left">
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group" id="brand">
								<label class="col-lg-2 control-label">{{__('Prescribed')}}</label>
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="prescribed" id="prescribed" required>
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" step="0.01" placeholder="{{__('Purchase price')}}" name="purchase_price" class="form-control">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" placeholder="{{__('Purchase quantity')}}" name="current_quantity" class="form-control">
								</div>
							</div>
