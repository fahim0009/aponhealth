<?php $__env->startSection('title'); ?>
    <?php echo e($product->name); ?> | nextlink.com
...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    <button type="button" class="btn btn-base-1 btn-icon-left" onclick="addToCart()">
                                        <i class="la la-shopping-cart"></i> <?php echo e(__('Add to cart')); ?>

                                    </button>
                                    <!-- Add to wishlist button -->
                                    <button type="button" class="btn btn-outline btn-base-1 btn-icon-left" onclick="addToWishList(<?php echo e($product->id); ?>)">
                                        <i class="la la-heart-o"></i>
                                        <span class="d-none d-md-inline-block"> <?php echo e(__('Add to wishlist')); ?></span>
                                    </button>
                                    <!-- Add to compare button -->
                                    <button type="button" class="btn btn-outline btn-base-1 btn-icon-left" onclick="addToCompare(<?php echo e($product->id); ?>)">
                                        <i class="la la-refresh"></i>
                                        <span class="d-none d-md-inline-block"> <?php echo e(__('Add to compare')); ?></span>
                                    </button>
                                </div>
                            </div>
    ...
    <section class="gry-bg">
                ...
                <div class="col-xl-3 d-none d-xl-block">
                    <div class="seller-top-products-box bg-white sidebar-box mb-3">
                        ...
                        <div class="box-content">
                            <?php $__currentLoopData = filter_products(\App\Models\Product::where('user_id', $product->user_id)->orderBy('num_of_sale', 'desc'))->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $top_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-3 product-box-3">
                                    <div class="clearfix">
                                        <div class="product-image float-left">
                                            <a href="<?php echo e(route('product', $top_product->slug)); ?>"><img src="<?php echo e(asset($top_product->thumbnail_img)); ?>" height="90" width="90" alt=""></a>
                                        </div>
                                    ...
                                    <div class="fluid-paragraph py-4">
                                        ...
                                        <?php if(Auth::check()): ?>
                                            ...
                                            <?php $__currentLoopData = $product->orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($orderDetail->order->user_id == Auth::user()->id): ?>
                                                    <?php
                                                        $commentable = true;
                                                    ?>
                                                <?php endif; ?>
                                    ...
                                    <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                        <div class="card-body p-0">
                                            <div class="card-image">
                                                ...
                                                <a href="<?php echo e(route('product', $related_product->slug)); ?>" class="d-block" style="background-image:url('<?php echo e(asset($related_product->thumbnail_img)); ?>');">
                                                </a>
        ...
        <style>
        .checkbox-alphanumeric input + label{
            ...
            .checkbox-alphanumeric input + label:hover{
                                  background:#0064A4;
                                  color:#fff;
            }
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7.4\htdocs\laravel\apon_health\apon_ecom\resources\views/frontend/product_details.blade.php ENDPATH**/ ?>