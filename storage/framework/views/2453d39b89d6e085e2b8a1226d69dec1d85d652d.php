                ...
                <div class="col-4">
                    <div class="icon-block icon-block--style-1-v5 text-center active">
                        ...
                        <div class="block-content d-none d-md-block">
                            <h3 class="heading heading-sm strong-300 c-gray-light text-capitalize" style="color: black !important; font-weight: 700 !important;">1. <?php echo e(__('My Cart')); ?></h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="inner">
            ...
            <div class="right">
                ...
                <?php $__currentLoopData = Session::get('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="price">
                        <div> Discount</div>
                        <div> <?php echo e(single_price($damount)); ?></div>
                    </div>
                    <div class="price">
                        <div class=" font-weight-bold"> TOTAL</div>
                        <div class=" font-weight-bold"> <?php echo e(single_price($subtotal+$tax+$shippingcost-$damount)); ?></div>
                    </div>
                </div>
            </div>
    </section>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/frontend/view_cart.blade.php ENDPATH**/ ?>