                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li class="<?php echo e(areActiveRoutes(['user-message.index'])); ?>">
                            <a class="nav-link" href="<?php echo e(route('user-message.index')); ?>">
                                <i class="fa fa-search"></i>
                                <span class="menu-title"><?php echo e(__('Regular Form')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
...
<?php /**PATH E:\xampp7.4\htdocs\laravel\apon_health\apon_ecom\resources\views/inc/admin_sidenav.blade.php ENDPATH**/ ?>