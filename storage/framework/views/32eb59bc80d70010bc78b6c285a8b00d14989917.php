        ...
        <div class="col-lg-6">
            ...
            <div class="product-description-wrapper">
                ...
                <form id="option-choice-form">
                    ...
                    <input type="hidden" name="prescribed" value="<?php echo e($product->prescribed); ?>">
                        ...
                        <div class="col-10">
                            <ul class="list-inline checkbox-alphanumeric checkbox-alphanumeric--style-1 mb-2">
                                <?php $__currentLoopData = $choice->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($key ==  0): ?>                                              
                                    <li>
                                        <input type="radio" id="<?php echo e($choice->name); ?>-<?php echo e($option); ?>" name="<?php echo e($choice->name); ?>" value="<?php echo e($option); ?>" checked="checked">
...
<?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/frontend/partials/addToCart.blade.php ENDPATH**/ ?>