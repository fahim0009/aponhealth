            ...
            <ul class="nav navbar-top-links">
                ...
                <li class="dropdown" id="lang-change">
                    ...
                    <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                        <img src="<?php echo e(asset('frontend/images/icons/flags/'.$locale.'.png')); ?>" class="flag" style="margin-right:6px;"><span class="language"><?php echo e(\App\Models\Language::where('code', $locale)->first()->name); ?></span>
                    </a>
                        ...
                        <div class="nano scrollable has-scrollbar" style="height: 265px;">
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                <ul class="head-list">
                                    ...
                                    <?php if($orders > 0): ?>
                                    <li>
                                        <a class="media" href="<?php echo e(route('admin.message.index')); ?>" style="position:relative">
                                            <span class="badge badge-header badge-info" style="right:auto;left:3px;"></span>
                                            <div class="media-body">
                                                <p class="mar-no text-nowrap text-main text-semibold"><?php echo e($unread); ?> new Message(s)</p>
                                            </div>
                                        </a>
                                    </li>
                                <?php endif; ?>
...
<?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/inc/admin_nav.blade.php ENDPATH**/ ?>