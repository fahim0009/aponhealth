...
<div class="col-lg-6 col-lg-offset-3">
    <div class="panel">
        ...
        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="<?php echo e(route('patient.update', $customers->id)); ?>" method="POST" enctype="multipart/form-data">
        	<?php echo csrf_field(); ?>
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="name"><?php echo e(__('Name')); ?></label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="<?php echo e(__('Name')); ?>" id="name" name="name" class="form-control" value="<?php echo e($customers->name); ?>" required>
                        <input type="hidden" id="userid" name="userid" class="form-control" value="<?php echo e($customers->id); ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" name="email" id="email" class="form-control"  value="<?php echo e($customers->email); ?>"  placeholder="Email">
                        <input type="hidden" name="exemail" id="exemail" class="form-control"  value="<?php echo e($customers->email); ?>"  placeholder="Email">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="<?php echo e(__('Phone No')); ?>" id="phone" name="phone"  value="<?php echo e($customers->phone); ?>"  class="form-control" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="date" id="dob" name="dob"  value="<?php echo e($customers->dob); ?>"  class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="address"><?php echo e(__('Address')); ?></label>
                    <div class="col-sm-9">
                        <textarea name="address" id="address" cols="20" rows="20" placeholder="type full address"> <?php echo e($customers->address); ?> </textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control mb-3" data-placeholder="Select your region" id="division" name="region" required>
                            <option value=" 
                            <?php if($customers->region): ?>
                                <?php echo e(\App\Models\Division::where('id', $customers->region)->first()->id); ?>

                            <?php else: ?> <?php endif; ?> "> 
                            <?php if($customers->region): ?>
                                <?php echo e(\App\Models\Division::where('id', $customers->region)->first()->name); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control mb-3" data-placeholder="Select your City" id="district" name="city" required>
                            <option value=" <?php if($customers->city): ?>
                                <?php echo e(\App\Models\District::where('id', $customers->city)->first()->id); ?>

                            <?php else: ?> 
                            <?php endif; ?> "> <?php if($customers->city): ?>
                                <?php echo e(\App\Models\District::where('id', $customers->city)->first()->name); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control mb-3" data-placeholder="Select your Area" id="upazila" name="area" required>
                            <option value=" <?php if($customers->area): ?>
                                <?php echo e(\App\Models\Upazila::where('id', $customers->area)->first()->id); ?>

                            <?php else: ?> 
                            <?php endif; ?> "> <?php if($customers->city): ?>
                                <?php echo e(\App\Models\Upazila::where('id', $customers->area)->first()->name); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control mb-3" data-placeholder="Select shipping Cost " id="shipping" name="shipping_cost" required>
                            <option value="<?php echo e($customers->shipping_cost); ?>"><?php echo e($customers->shipping_cost); ?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="postal_code" id="postal_code" class="form-control" placeholder="postal code" maxlength="4" value="<?php echo e($customers->postal_code); ?>" required>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        $('#email').keyup(function(){
          ...
          var exemail = $('#exemail').val();
          var _token = $('input[name="_token"]').val();


           $.ajax({
            url:"<?php echo e(route('email.recheck')); ?>",
            method:"POST",
            data:{email:email, exemail:exemail, userid:userid, _token:_token},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/customers/edit.blade.php ENDPATH**/ ?>