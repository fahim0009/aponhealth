            ...
            <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
                <tbody>
                    <tr>
                        ...
                        <td><?php echo e(single_price($order->medicationDetails->sum('price'))); ?></td>
                    </tr>
                    <tr>
                        <th class="gry-color text-left">Shipping Cost</td>
                        <td><?php echo e(single_price($order->medicationDetails->sum('shipping_cost'))); ?></td>
                    </tr>
                    <tr class="border-bottom">
                        <th class="gry-color text-left">Total Tax</td>
                        <td><?php echo e(single_price($order->medicationDetails->sum('tax'))); ?></td>
                    </tr>
                    <tr>
...
<?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/invoices/medication.blade.php ENDPATH**/ ?>