...
<div class="panel">
    ...
    <div class="panel-body">
        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php $__currentLoopData = $rmed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(route('madication.regular')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="rmid" value="<?php echo e($data->id); ?>">
                                <input type="hidden" name="rmmobile" value="<?php echo e($data->mobile); ?>">
                    ...
                    <div class="modal fade" id="view<?php echo e($data->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <?php $__currentLoopData = \App\Models\History::where('rm_id', '=', $data->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $his): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="column">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/medication/regular.blade.php ENDPATH**/ ?>