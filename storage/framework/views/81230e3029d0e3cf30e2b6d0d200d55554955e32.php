...
<head>
    ...
    <title><?php echo e(config('app.name', 'Apon Health')); ?></title>
...
<?php echo $__env->yieldContent('css'); ?>
    ...
    <link rel='stylesheet' type='text/css' href="<?php echo e(asset('invoice/css/style.css')); ?>" />
<!--JAVASCRIPT-->
    <!--=================================================-->
...
<?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/layouts/app.blade.php ENDPATH**/ ?>