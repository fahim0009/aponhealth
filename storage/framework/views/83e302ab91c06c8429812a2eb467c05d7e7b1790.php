    ...
    <div class="col-md-6">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <br>
                <p class="text-lg text-main">Total published products: <span class="text-bold"><?php echo e(\App\Models\Product::where('published', 1)->get()->count()); ?></span></p>
                <?php if(\App\Models\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1): ?>
                    <p class="text-lg text-main">Total seller's products: <span class="text-bold"><?php echo e(\App\Models\Product::where('published', 1)->where('added_by', 'seller')->get()->count()); ?></span></p>
                <?php endif; ?>
                <p class="text-lg text-main">Total admin's products: <span class="text-bold"><?php echo e(\App\Models\Product::where('published', 1)->where('added_by', 'admin')->get()->count()); ?></span></p>
                <br>
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <p class="text-semibold text-3x text-main"><?php echo e(\App\Models\Category::all()->count()); ?></p>
                ...
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <p class="text-semibold text-3x text-main"><?php echo e(\App\Models\SubSubCategory::all()->count()); ?></p>
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <p class="text-semibold text-3x text-main"><?php echo e(\App\Models\SubCategory::all()->count()); ?></p>
                ...
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <p class="text-semibold text-3x text-main"><?php echo e(\App\Models\Brand::all()->count()); ?></p>
...
<?php if((Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && \App\Models\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1): ?>
    <div class="row">
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <p class="text-semibold text-3x text-main"><?php echo e(\App\Models\Seller::all()->count()); ?></p>
                <br>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                ...
                <p class="text-semibold text-3x text-main"><?php echo e(\App\Models\Seller::where('verification_status', 1)->get()->count()); ?></p>
                <br>
                <a href="<?php echo e(route('sellers.index')); ?>" class="btn-link">Manage Sellers <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                ...
                <p class="text-semibold text-3x text-main"><?php echo e(\App\Models\Seller::where('verification_status', 0)->count()); ?></p>
                <br>
                <a href="<?php echo e(route('sellers.index')); ?>" class="btn-link">Manage Sellers <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
                        ...
                        <tbody>
                            <?php $__currentLoopData = \App\Models\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\App\Models\Product::where('category_id', $category->id)->sum('num_of_sale')); ?></td>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/admin_dashboard.blade.php ENDPATH**/ ?>