...
<?php if(!empty($seosetting->description)): ?>
<meta name="description" content="<?php echo e($seosetting->description); ?>">
<?php endif; ?>

<?php if(!empty($seosetting->keyword)): ?>
<meta name="keywords" content="<?php echo e($seosetting->keyword); ?>">
<?php endif; ?>

<?php if(!empty($seosetting->author)): ?>
<meta name="author" content="<?php echo e($seosetting->author); ?>">
<?php endif; ?>

<?php if(!empty($seosetting->sitemap_link)): ?>
<meta name="sitemap_link" content="<?php echo e($seosetting->sitemap_link); ?>">
<?php endif; ?>

<?php echo $__env->yieldContent('meta'); ?>
<!-- Favicon -->
<link name="favicon" type="image/x-icon" href="<?php echo e(asset(\App\Models\GeneralSetting::first()->favicon)); ?>" rel="shortcut icon" />
...
<link type="text/css" href="<?php echo e(asset('frontend/css/animate.min.css')); ?>" rel="stylesheet">
<!-- Global style (main) -->
<link type="text/css" href="<?php echo e(asset('frontend/css/active-shop.css')); ?>" rel="stylesheet" media="screen">

<link type="text/css" href="<?php echo e(asset('frontend/css/app.css')); ?>" rel="stylesheet">
<link type="text/css" href="<?php echo e(asset('frontend/css/swiper-bundle.min.css')); ?>" rel="stylesheet">
...
<!-- color theme -->
<link href="<?php echo e(asset('frontend/css/colors/'.\App\Models\GeneralSetting::first()->frontend_color.'.css')); ?>" rel="stylesheet">
...
<?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>