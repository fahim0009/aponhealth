                    ...
                    <?php if($order != null): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo e(single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax') + $order->shipping_cost)); ?>
                            ...
                            <td>
                                <div class="btn-group dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li><a href="<?php echo e(route('orders.prescription.show', encrypt($order->id))); ?>"><?php echo e(__('Prescription View')); ?></a></li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/orders/index.blade.php ENDPATH**/ ?>