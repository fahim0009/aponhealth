...
<div class="modal-body gry-bg px-3 pt-0">
    <div class="pt-4">
        <ul class="process-steps clearfix">
            ...
            <li <?php if($order->delivery_status == 'processing' || $order->delivery_status == 'on_delivery'|| $order->delivery_status == 'delivered'): ?> class="done" <?php else: ?> class="active" <?php endif; ?>>
                <div class="icon">2</div>
                <div class="title"><?php echo e(__('On Processing')); ?></div>
            </li>
            </li>
            <li <?php if($order->delivery_status == 'delivered' || $order->delivery_status == 'on_delivery'): ?> class="done" <?php else: ?> class="active" <?php endif; ?>>
                <div class="icon">4</div>
                <div class="title"><?php echo e(__('On delivery')); ?></div>
            </li>
            <li <?php if($order->delivery_status == 'delivered'): ?> class="done" <?php else: ?> class="active" <?php endif; ?>>
                ...
                <div class="col-lg-6">
                    <table class="details-table table">
                        ...
                        <tr>
                            ...
                            <td><?php echo e(ucfirst(str_replace('_', ' ', $order->delivery_status))); ?></td>
                        </tr>
                        <tr>
                    ...
                    <table class="table details-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <strong><?php echo e(single_price($order->discount)); ?></strong>
                                </td>
                            </tr>
                            <tr>
...
<?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/frontend/partials/order_details_customer.blade.php ENDPATH**/ ?>