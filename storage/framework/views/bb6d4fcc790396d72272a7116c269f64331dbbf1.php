      ...
      <div class="row ">
        ...
        <div class="col-lg-7">
          <div class="contact-box-layout1 shadow-sm p-4">
            ...
            <form class="contact-form-box mt-4"  action="<?php echo e(route('regularmedication.store')); ?>" method="post">
              <?php echo csrf_field(); ?>
              <div class="row">
        ...
        <div class="col-lg-4 pl-4">
          <div class="contact-box-layout1 p-4">
            <img src="<?php echo e(asset('images/right.png')); ?>" height="80%" width="300" alt="">
          </div>
        </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/frontend/userform.blade.php ENDPATH**/ ?>