...
<meta charset="UTF-8">
    ...
    <style media="all">
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(<?php echo e(asset('fonts/khmer.ttf')); ?>) format('true-type');
        }
        ...
        *{
        ...
        <div style="padding: 1.5rem;">
            <table>
                ...
                <tr><td class="gry-color small"><?php echo e($shipping_address->address); ?>, <?php echo e($shipping_address->area); ?>, <?php echo e($shipping_address->city); ?>-<?php echo e($shipping_address->post_code); ?></td></tr>
                ...
                <tbody class="strong">
                    <?php $__currentLoopData = $order->orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="">
                            ...
                            <td class="gry-color"><?php echo e($orderDetail->price/$orderDetail->quantity); ?></td>
                            <td class="text-right"><?php echo e($orderDetail->price+$orderDetail->tax); ?></td>
                        </tr>
            ...
            <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
                <tbody>
                    <tr>
                        ...
                        <td><?php echo e($order->orderDetails->sum('price')); ?></td>
                    </tr>
                    <tr>
                        <th class="gry-color text-left">Shipping Cost</td>
                        <td><?php echo e($order->shipping_cost); ?></td>
                    </tr>
                    <tr>
...
<?php /**PATH E:\xampp7.4\htdocs\laravel\apon_ecommerce\apon_ecom\apon_ecom_new\resources\views/invoices/customer_invoice.blade.php ENDPATH**/ ?>